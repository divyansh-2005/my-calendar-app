...
const Footer = () => {
  return (
    <footer className="sm:w-max md:w-full grid grid-cols-1 lg:grid-cols-3 gap-4 p-4 bg-customGray border-t border-customWhite ">
      ...
      <div className="lg:col-span-1 justify-center flex flex-col items-center mr-6">
