...
const RegisterPage = () => {
  ...
  return (
    <div
      className={`transition-all duration-300 ease-in-out ${themeCtx.theme === "light" ? "bg-customWhite text-customGray" : "bg-customGray text-customWhite"} register-page`}
    >
      <div
      ...
      >
        ...
        <div className="left-text">
          <h3>
            Manage your daily <span id="expense">expenses</span> and{" "}
            <span id="task">tasks</span> in <span id="place">one place</span>.
          </h3>
        </div>
      </div>
      <div
